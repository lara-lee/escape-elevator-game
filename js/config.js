...
const CONFIG = {
  ...
  SPAWN_FLOOR_FACTOR: 0.010,
  SPAWN_FLOOR_MAX: 0.35,
  SPEED_FLOOR_FACTOR: 0.010,
  SPEED_FLOOR_MAX: 0.55,
  ...
  STAGES: [
    ...
    { id:2, label:'2단계', name:'평범한 퇴근', emoji:'🚶', color:'#3b82f6', floors:20, recovers:2, spawnMin:2.1, spawnMax:3.6, speedMul:0.85, lives:3, dots:2 },
    { id:3, label:'3단계', name:'러시아워',   emoji:'🏃', color:'#f59e0b', floors:20, recovers:3, spawnMin:1.6, spawnMax:2.9, speedMul:1.05, lives:3, dots:3 },
    { id:4, label:'4단계', name:'야근 지옥',   emoji:'🔥', color:'#ef4444', floors:20, recovers:4, spawnMin:1.2, spawnMax:2.4, speedMul:1.25, lives:4, dots:4 },
    { id:5, label:'5단계', name:'대표님 등장', emoji:'😈', color:'#a855f7', floors:20, recovers:5, spawnMin:1.0, spawnMax:2.0, speedMul:1.50, lives:5, dots:5, extra:['ceo'] },
  ],
